...
const { icons, rankIcon } = require("../common/icons.js");
const {
    clampValue,
    flexLayout,
    getCardColors,
...
const { statCardLocales } = require("../translations.js");
...
const renderStatsCard = (stats = {}, options = { hide: [] }) => {
  ...
  */
    ...
    const defaultCardWidth = (hide_rank ? CARD_DEFAULT_WIDTH : RANK_CARD_DEFAULT_WIDTH) + iconWidth;
